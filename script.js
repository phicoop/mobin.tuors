document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatbotResponses = [
        ...
        { keywords: ["Fach","Fächer","fächer", "fach", "unterricht","Unterricht", "subjects","Topics", "algebra","calculus", "diskret", "diskrete", "Stunden"], response: "Ich biete Nachhilfe in so ziemlich allen Fächern der Mathematik. Lasse mir einfach deine Unterlagen zukommen und ich schaue mir das ganze schnellstmöglich an!", response_en: "I offer tutoring in almost all subjects of mathematics. Just send me your documents and I will take a look at them as soon as possible!" },
