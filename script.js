document.addEventListener('DOMContentLoaded', () => {
    ...
    const chatbotResponses = [
        ...
        { keywords: ["preis", "kosten", "was kostet", "kostet", "price", "cost"], response: "Eine Probelektion kostet 15 CHF, die nach Ablauf der Stunde vom Regulärpreis von 25CHF abgelöst wird.", response_en: "A trial lesson costs 15 CHF, which is replaced by the regular price of 25CHF after the hour." },
